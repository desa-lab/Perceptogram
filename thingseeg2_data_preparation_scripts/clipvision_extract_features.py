...
with torch.no_grad():
    ...
    np.save('cache/thingseeg2_extracted_embeddings/test_clipvision.npy',test_clip)
    ...
    np.save('cache/thingseeg2_extracted_embeddings/train_clipvision.npy',train_clip)
