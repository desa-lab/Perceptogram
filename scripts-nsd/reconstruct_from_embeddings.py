...
pred_clipvision = np.load(f"cache/nsd_preproc/predicted_embeddings/sub-{sub:02d}/regress_clip.npy", mmap_mode='r') # Load the embeddings
pred_vae = np.load(f"cache/nsd_preproc/predicted_embeddings/sub-{sub:02d}/regress_vae.npy", mmap_mode='r')
recon_dir = f"results/nsd_preproc/sub-{sub:02d}/unclip/" # Directory to save the reconstructed images
