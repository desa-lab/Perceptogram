...
weights_filename = f'regress-encode_pca1k_weights{param}.pkl'
save_dir = f'cache/nsd_preproc/predicted_fmri/sub-{sub:02d}/'
os.makedirs(save_dir, exist_ok=True)
pred_filename = f'regress-encode_pca1k{param}.npy'
 
# Regression
train_latents= np.load(f'cache/nsd_extracted_embeddings/train_pca1k_sub-{sub:02d}.npy', mmap_mode='r')
test_latents = np.load(f'cache/nsd_extracted_embeddings/test_pca1k.npy', mmap_mode='r')
...
# -0.07377212771651764 128.64380791822558 0.09557846222488119 for 100
# -0.049618788647096124 127.17852895662024 0.09710318232890795 for 1000
# 0.004992942363596601 123.77854156503147 0.10241626039355467 for 10000
# 0.0058651442615390405 123.71698628931586 0.10560473107635485 for 100000
# 0.0007737786686303979 124.03662927871166 0.10601100856094071 for 1000000
