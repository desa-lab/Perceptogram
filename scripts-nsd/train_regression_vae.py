...
weights_filename = f'regress_vae_weights{param}.pkl'
save_dir = f'cache/nsd_preproc/predicted_embeddings/sub-{sub:02d}/'
os.makedirs(save_dir, exist_ok=True)
latent_filename = f'regress_vae{param}.npy'

# Regression
train_latents= np.load(f'cache/nsd_extracted_embeddings/train_vae_sub-{sub:02d}.npy', mmap_mode='r')
test_latents = np.load(f'cache/nsd_extracted_embeddings/test_vae.npy', mmap_mode='r')
...
# -0.4390336579945455 1016.828907029546 0.45618717521861946 for 1000
# -0.002186476670422209 973.8391117083643 0.4923541794585158 for 10000
# 0.05756898376386066 952.0799242710801 0.511925777531332 for 100000
# 0.03461339930352723 969.207712415293 0.4992492808217158 for 1000000