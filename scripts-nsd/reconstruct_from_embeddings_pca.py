...
pred_latents = np.load(f'cache/nsd_preproc/predicted_embeddings/sub-{sub:02d}/regress_pca1k.npy', mmap_mode='r')

recon_dir = f'results/nsd_preproc/sub-{sub:02d}/pca1k{param}/'
