...
pred_latents = np.load(f'cache/thingseeg2_preproc/predicted_embeddings/sub-{sub:02d}/regress_ica1k.npy', mmap_mode='r')

recon_dir = f'results/thingseeg2_preproc/sub-{sub:02d}/ica1k{param}/'
