...
# latent_filename = f'regress_clip{param}_grayscaled.npy'
...
# train_latents= np.load('cache/thingseeg2_extracted_embeddings/train_clip_grayscaled.npy', mmap_mode='r')[ids]
# test_latents = np.load('cache/thingseeg2_extracted_embeddings/test_clip_grayscaled.npy', mmap_mode='r')
