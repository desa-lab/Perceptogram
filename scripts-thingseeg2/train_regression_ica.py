...
print(reg.score(eeg_test,test_latents), average_euclidean_distance, correlations) # -0.005042616763647331 41.001279083546976 0.03342913119452902 when alpha=1000
