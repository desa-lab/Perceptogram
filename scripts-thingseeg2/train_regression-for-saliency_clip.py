...
vdvae_weights_filename = f'regress-for-saliency_clip_weights{param}.pkl'
save_dir = f'cache/thingseeg2_preproc/predicted_embeddings/sub-{sub:02d}/'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
latent_filename = f'regress-for-saliency_clip{param}.npy'
...
test_latetns_mean = np.mean(test_latents,axis=0)
test_latents_std = np.std(test_latents,axis=0)
test_latents = (test_latents - test_latetns_mean) / test_latents_std
